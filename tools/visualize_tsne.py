...
def main():
    ...
    parser.add_argument('--output', type=str, default=os.path.join(PROJECT_ROOT, 'tools/celeb/celebv2-intriFace.png'))
    ...
    parser.add_argument('--aggregate', type=str, choices=['none', 'video'], default='none', help='Whether to aggregate by video (calculate the average of the same video frame)')
    ...
    parser.add_argument('--n_iter', type=int, default=1300)
